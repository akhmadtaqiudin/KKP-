	...
	<s:div cssClass="header">
		...
		<s:form namespace="/karyawan" method="post" theme="bootstrap" cssClass="form-horizontal" id="input">
			...
			<s:select list="#{'':'Ambon','Bali':'Bali','Balikpapan':'Balikpapan','Bandung':'Bandung',
					...
					'Indramayu':'Indramayu','Jakarta':'Jakarta','Jayapura':'Jayapura','Jepara':'Jepara',
					'Karawang':'Karawang','Klaten':'Klaten','Kotabaru':'Kotabaru','Kupang':'Kupang',
			...
			<div class="footer">
			<s:submit action="EditeKaryawan" value="Simpan" cssClass="btn btn-primary"/>
